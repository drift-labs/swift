...
impl OrderMetadataAndMessage {
    ...
    pub fn jsonify(&self) -> serde_json::Value {
        ...
        self.order_message
            ...
            .expect("serialize SwiftOrderParams");
...
mod tests {
    ...
    fn order_metadata_jsonify() {
        ...
        let swift_order_params = SignedMsgOrderParamsMessage {
            sub_account_id: 2,
        ...
        let swift_order_message_with_prefix = SignedOrderParamsMessageWithPrefix {
            discriminator: [0u8; 8],
            message: swift_order_params,
        };
        ...
        let order_metadata_json = OrderMetadataAndMessage {
            ...
            taker_authority,
            order_signature,
            uuid: swift_order_params.uuid,
            order_message: swift_order_message_with_prefix,
            ts: 55555,
        }
        .jsonify();
        ...
        assert_eq!(
            ...
            faster_hex::hex_string(
                swift_order_message_with_prefix
                    .try_to_vec()
                    .unwrap()
                    .as_slice()
            ),
